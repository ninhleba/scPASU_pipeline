...
comp <- list(c('iAP_G0','iAP_G4'))
apa_dir <- '~/Desktop/SC296_scPASU_run/outputs/cancercell/5b_APA_testing/iAP_G0_v_iAP_G4/'
deg_dir <- '~/Desktop/SC296_scPASU_run/outputs/cancercell/DEG_pseudobulk/iAP_G0_v_iAP_G4/'
...
ggsave(paste0(apa_dir,'DEG_APA_ovl_barplot.png'),width = 8, height = 8, unit = 'in')
