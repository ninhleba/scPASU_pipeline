...
ref_genome=$SCRATCH/mm10/fasta/genome.fa
compartment=cancercell
fprefix=${compartment}
dir=$SCRATCH/SC296_scPASU_run/outputs/${compartment}/
scriptdir=$SCRATCH/SC296_scPASU_run/Scripts/${compartment}/3_peak_ref_cleanup/
